...
import ControlPanelS4 from "./ControlPanelS4";

class SidePanelS4 extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="side-panel">
        ...
        <div className="ctrl-panel-container">
          <ControlPanelS4 criteriaMet={this.changeCriteriaMet} />
        </div>
