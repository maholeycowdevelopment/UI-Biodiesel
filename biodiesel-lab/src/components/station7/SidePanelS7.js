...
import ControlPanelS7 from "./ControlPanelS7";

class SidePanelS7 extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="side-panel">
        ...
        <div className="ctrl-panel-container">
          <ControlPanelS7 criteriaMet={this.changeCriteriaMet} />
        </div>
